...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $GLOBALS['webroot'] ?>/library/js/fancybox-1.3.4/jquery.fancybox-1.3.4.css"
		  media="screen"/>
					...
					<div class="cancel-float" style='float:left'>
						<table class='text'>
							<tr>
								...
								<td><input type='text' name='date_from' id="date_from" size='18' value='<?php echo attr($sql_date_from); ?>'
										   readonly="readonly" title='<?php echo attr($title_tooltip) ?>'> <img src='../pic/show_calendar.gif'
																												align='absbottom' width='24'
																												height='22' id='img_from_date'
																												border='0' alt='[?]'
																												style='cursor:pointer'
																												title='<?php echo xla('Click here to choose a date'); ?>'>
								</td>
								<td class='label'><?php echo xlt('To{{range}}'); ?>:</td>
								<td><input type='text' name='date_to' id="date_to" size='18' value='<?php echo attr($sql_date_to); ?>'
										   readonly="readonly" title='<?php echo attr($title_tooltip) ?>'> <img src='../pic/show_calendar.gif'
																												align='absbottom' width='24'
																												height='22' id='img_to_date'
																												border='0' alt='[?]'
																												style='cursor:pointer'
																												title='<?php echo xla('Click here to choose a date'); ?>'>
								</td>
			...
			<table width=90% align="center" cellpadding="5" cellspacing="0" style="font-family:tahoma;color:black;" border="0">
				...
				<?php if ($srch_option == "Medications" || $srch_option == "Allergies" || $srch_option == "Problems") { ?>
					...
					<?php foreach ($patFinalDataArr as $patKey => $patDetailVal) { ?>
						<tr bgcolor="#CCCCCC" style="font-size:15px;">
							<td><?php if ($patDetailVal['patient_date'] != '') {
									echo date(DateFormatRead(true) . " H:i:s", strtotime($patDetailVal['patient_date']));
								} else {
									echo "";
								}; ?></td>
							<td><?php echo text($patDetailVal['patient_name']); ?></td>
